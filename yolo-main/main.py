...
#        print(row)
    ...
    print(len(people_entering))
    #print(len(exiting))
    i=(len(entering))
    o=(len(exiting))
    cv2.putText(frame, "area 1 entrada=" + str(i), (60, 80), cv2.FONT_HERSHEY_COMPLEX, 0.7, (0, 0, 255), 2)

    cv2.putText(frame,"area 2 de salida=" + str(o),(60,140),cv2.FONT_HERSHEY_COMPLEX,(0.7),(255,0,255),2)
